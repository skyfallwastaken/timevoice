<script lang="ts">
  ...
  let dateRange = $derived(
    ($page.props.dateRange as { start: string; end: string }) || {
      start: "",
      end: "",
    },
  );
  ...
  $effect(() => {
    ...
    if (currentRange.start) {
      startDate = new Date(currentRange.start + "T00:00:00");
      $dateFilterForm.start_date = currentRange.start;
    }
    if (currentRange.end) {
      endDate = new Date(currentRange.end + "T00:00:00");
      $dateFilterForm.end_date = currentRange.end;
    }
  });
            ...
            <div class="p-4">
              <div class="flex items-start justify-between">
                <div class="flex-1 min-w-0">
                  ...
                  <div
                    class="flex items-center gap-3 text-sm text-fg-muted mt-1"
                  >
                    {#if entry.project}
