<script lang="ts">
  ...
  $effect(() => {
    if (colors.length > 0 && !createForm.data.color) {
      createForm.data.color = colors[0]
    }
  })
  ...
  function startEditing(project: Project) {
    ...
    editForm.data.client_id = project.client?.id?.toString() || ''
    editForm.data.color = project.color
    editForm.data.billable_default = project.billable_default
  }
  ...
  <div class="flex-1 p-6 overflow-auto">
    <div class="max-w-4xl mx-auto space-y-6">
      ...
      <div class="flex items-center gap-3">
        <FolderKanban class="w-6 h-6 text-bright-green" />
          ...
          <div>
            ...
            <div class="flex flex-wrap gap-2">
              {#each colors as color}
                <button
                  type="button"
                  onclick={() => createForm.data.color = color}
                    ...
                    <div>
                      ...
                      <div class="flex flex-wrap gap-2">
                        {#each colors as color}
                          <button
                            type="button"
                            onclick={() => editForm.data.color = color}
