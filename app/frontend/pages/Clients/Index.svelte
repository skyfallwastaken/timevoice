<script lang="ts">
  ...
  function startEditing(client: Client) {
    editingId = client.id
    editForm.data.name = client.name
    editForm.data.billing_address = client.billing_address || ''
  }
  ...
  <div class="flex-1 p-6 overflow-auto">
    <div class="max-w-4xl mx-auto space-y-6">
      ...
      <div class="flex items-center gap-3">
        <Users class="w-6 h-6 text-bright-blue" />
                  ...
                  <div class="flex items-center justify-between">
                    <div>
                      ...
                      {#if client.billing_address}
                        <p class="text-sm text-fg-muted">{client.billing_address}</p>
                      {:else}
