  ...
  <div class="max-w-md flex flex-col items-center" style="gap: 2.5rem">
    ...
    >
      ...
      <form action="/auth/google_oauth2" method="post">
        ...
        <button
          type="submit"
          class="w-full flex items-center justify-center gap-3 bg-bg-tertiary hover:bg-bg-quaternary text-fg-primary px-4 py-3 rounded-[10px] transition-colors duration-150 font-medium"
      ...
      <p class="text-center text-sm text-fg-dim">
        Signing in will create your workspace if you do not have one yet.
      </p>
    </div>
  </div>
</div>
